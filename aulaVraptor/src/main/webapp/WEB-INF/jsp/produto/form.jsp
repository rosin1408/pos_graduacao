...
<jsp:body>
	...
	<form class="form-horizontal" action="${linkTo[ProdutoController].adicionar}" method="post">
		<fieldset>
			<!-- Form Name -->
			...
			<div class="form-group">
				...
				<div class="col-xs-6">
					<input id="nome" name="produto.nome" placeholder=""
						class="form-control input-md" type="text" value="${produto.nome}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-xs-3 control-label" for="valor">Valor:</label>
				<div class="col-xs-6">
					<input id="valor" name="produto.valor" placeholder="" value="${produto.valor}"
